...
Usage: $(basename $0) <OPTION>...
       Generates manifest for abundance_estimation nextflow pipeline using data stored centrally in the PaM informatics legacy pipelines

       -l,
       Lanes file - file containing list of lanes to be ran through the abundance_estimation pipeline (mandatory)
       -m,
       Manifest file - name of the manifest file generated to be used in the abundance_estimation pipeline - default: manifest.csv (optional)
       -h,
