process BOWTIE_INDEX {
    ...
    script:
    """
    bowtie2-build $subset_fasta gtdb_subset.bt2 --threads 4 --large-index
    """
}
...
process BOWTIE2SAMTOOLS {
    ...
    script:
    """
    bowtie2 -p $threads -x gtdb_subset.bt2 -1 $first_read -2 $second_read | samtools sort -@ $threads -o ${sample_id}".sorted.bam"
